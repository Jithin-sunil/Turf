          ...
          <div class="ml-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="Guest/Newuser.php" class="nav-link">User Registration</a></li>
                <li><a href="Guest/Newowner.php" class="nav-link">Turf Registration</a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 ml-auto">
            <h1 class="text-blue"><b>LeT'S PLaY</b></h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta, molestias repudiandae pariatur.</p>
            <div id="date-countdown"></div>
            <p>
              <a href="Guest/Login.php" class="btn btn-primary py-3 px-4 mr-3">Login</a>
            </p>  
          </div>
        </div>
      </div>
