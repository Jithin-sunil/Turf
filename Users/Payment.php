...
$up="Update tbl_booking set booking_status=1 where booking_id=".$_GET['pid'];
    if($con->query($up))
	{
		echo "<script>alert('Payment Successful');window.location='Success.html';</script>";
    }
	...
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				<div class="input-box">
					<input class="name" type="text" name="txtname" id="txtname" placeholder="First Name" required autocomplete="off">
